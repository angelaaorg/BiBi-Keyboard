...
internal fun CurrentAsrVendorConfig(
    ...
    when (selectedVendor) {
        ...
        AsrVendor.MiMo -> {
            ...
            val itemCount = primaryGroupCount ?: if (showCustomEndpoint) 7 else 6
            AsrDropdownPreference(
            ...
            AsrActionPreference(
                ...
                count = itemCount,
                onClick = {
                    val url = if (mimoEndpointPreset == Prefs.MIMO_ENDPOINT_PRESET_PAYGO || mimoEndpointPreset == Prefs.MIMO_ENDPOINT_PRESET_CUSTOM) {
